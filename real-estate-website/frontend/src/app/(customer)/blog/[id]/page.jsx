    ...
    return (
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link href="/blog" className="text-primary-blue hover:text-accent-green">
            ← Back to Blog
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="max-w-3xl mx-auto mb-8">
        <Link href="/blog" className="text-primary-blue hover:text-accent-green flex items-center">
      ...
      <div className="max-w-3xl mx-auto mb-8">
        ...
        <div className="flex items-center text-gray-600 mb-6">
          ...
          <div>
            ...
            <p className="text-sm">{post.date} • {post.category}</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto mb-12">
        <div className="prose lg:prose-lg" dangerouslySetInnerHTML={{ __html: post.content }}></div>
      </div>
            ...
            <div key={relatedPost.id} className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                ...
                <Link 
                  ...
                  className="text-primary-blue hover:text-accent-green text-sm"
                >
                  Read More →
                </Link>
              </div>
