...
export default function PaymentHistory() {
    ...
    if (payments.length > 0) {
      ...
      if (filterOptions.property !== 'all') {
        filtered = filtered.filter(payment => 
          payment.propertyId.toString() === filterOptions.property
        );
      }
  ...
  const uniqueProperties = [
    ...
    ...Array.from(new Set(payments.map(p => p.propertyId)))
      .map(id => {
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      {payments.length === 0 ? (
        <div className="bg-light-blue p-8 rounded-lg text-center">
          <h2 className="text-xl font-semibold mb-4">You don't have any payment records yet.</h2>
          <p className="mb-6">Once you make payments for your properties, they will appear here.</p>
          <Link 
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
                  ...
                  {filteredPayments.map((payment) => (
                    <tr key={payment.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        <Link href={`/lands/details/${payment.propertyId}`} className="hover:text-primary-blue">
            ...
            {filteredPayments.length === 0 && (
              <div className="p-6 text-center">
                <p className="text-gray-500">No payments match your filter criteria.</p>
              </div>
            )}
          </div>
          ...
          <div className="mt-8 bg-light-blue p-6 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">
                  {new Date(Math.max(...payments.map(p => new Date(p.date)))).toLocaleDateString()}
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="border-t border-b border-gray-200 py-6 mb-6">
                <div className="flex justify-between mb-4">
                  <div>
                    ...
                    <p className="font-semibold">REC-{selectedPayment.id.toString().padStart(6, '0')}</p>
                  </div>
                ...
                <div className="mb-4">
                  ...
                  <p className="font-semibold">{selectedPayment.propertyTitle}</p>
                </div>
