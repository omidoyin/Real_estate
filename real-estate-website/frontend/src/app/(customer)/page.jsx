        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-4 rounded-lg shadow-md">
              <div className="aspect-w-16 aspect-h-9 bg-gray-200 mb-4 rounded">
      ...
      <section className="py-16 bg-primary-blue text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/lands/available"
              className="bg-white text-primary-blue px-6 py-3 rounded-lg text-lg font-semibold hover:bg-light-blue"
            >
              Browse Properties
            </Link>
            <Link
              href="/contact"
              className="bg-accent-green text-white px-6 py-3 rounded-lg text-lg font-semibold hover:bg-green-600"
            >
              Contact Us
            </Link>
          </div>
          ...
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
            ...
            <form className="flex flex-col md:flex-row gap-4">
              <input
                ...
                className="flex-grow px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue"
                required
              />
              <button
                type="submit"
                className="bg-primary-blue text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700"
              >
                Subscribe
              </button>
            </form>
